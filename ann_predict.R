...
setwd("D:\\Documents\\Study and small Project training\\project_tsunami\\test\\gab")
options(scipen = 999)
...
data <- read.csv("Gempa_Tsunami_BMKG_Bathy_Gab.csv")
...
data %>% 
  ...
  labs(x = "Year",
       ...
       title = "Total Observations Tsunami Each Year (2010-2016)",
       caption = "Source: Significant Tsunami 2010-2016 by BMKG") + 
  theme_bw()
...
data %>% 
  ...
  labs(x = "Year",
       ...
       title = "Total Observations Earthquake Each Year (2010-2016)",
       caption = "Source: Significant Earthquake 2010-2016 by BMKG") + 
  theme_bw()
